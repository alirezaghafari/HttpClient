...
public class ComposeRequestPanel extends JPanel {
    ...
    public void setTheme(String st) {
        if (st.equalsIgnoreCase("light")) {
            ...
            for (Component component : headerPanel.getComponents()) {
                ...
                JTextField keyF=(JTextField)(((JScrollPane) tempPanel.getComponent(0)).getViewport().getView());
                JTextField valueF=(JTextField)(((JScrollPane) tempPanel.getComponent(1)).getViewport().getView());
                if(!keyF.getText().equals(""))
                    keyF.setForeground(Color.darkGray);
                if(!valueF.getText().equals(""))
                    valueF.setForeground(Color.darkGray);
            ...
            for (Component component : headerPanel.getComponents()) {
                ...
                JTextField valueF=(JTextField)(((JScrollPane) tempPanel.getComponent(1)).getViewport().getView());
                if(!keyF.getText().equals(""))
                    keyF.setForeground(Color.white);
                if(!valueF.getText().equals(""))
                    valueF.setForeground(Color.white);
    ...
    public void addHandler(JTextField keyField, JTextField valueField, JButton removeButton) {
        ...
        removeButton.addActionListener(e -> {
            Component c = (Component) e.getSource();
            if (e.getSource() instanceof JButton && headerPanel.getComponentCount()>1)
